...
models/players/mission_new/dress
{
	{
		map models/players/mission_new/dress
		rgbGen lightingDiffuse
	}
	{
...
models/players/mission_new/hands
{
	{
		map models/players/mission_new/hands
		rgbGen lightingDiffuse
	}
	{
...
models/players/mission_new/hips
{
	{
		map models/players/mission_new/hips
		rgbGen lightingDiffuse
	}
	{
		map models/players/mission_new/hips_spec
		blendFunc GL_SRC_ALPHA GL_ONE
		detail
		alphaGen lightingSpecular
	}
...
models/players/mission_new/torso
{
	{
		map models/players/mission_new/torso
		rgbGen lightingDiffuse
	}
	{
		map models/players/mission_new/torso_spec
		blendFunc GL_SRC_ALPHA GL_ONE
		detail
		alphaGen lightingSpecular
	}
...
models/players/mission_new/eyebrow
{
	cull	disable
	{
		map models/players/mission_new/eyebrow
		blendFunc GL_SRC_ALPHA GL_ONE_MINUS_SRC_ALPHA
		rgbGen lightingDiffuse
	}
}
...
models/players/oldrepsold/helmet_tsf
{
    cull disable
    {
        map models/players/oldrepsold/helmet_tsf
        rgbGen lightingDiffuse
    }
    {
        map models/players/oldrepsold/helmet_spec
