...
//##### CQ BACKSTREETS
//####################
gfx/automap/mb2_cq_backstreets
{
	nopicmip
    {
		clampmap gfx/automap/mb2_cq_backstreets
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_cq_backstreetsfull
{
	nopicmip
    {
		map gfx/automap/mb2_cq_backstreetsfull
		blendfunc blend
		alphaGen vertex
    }
}

gfx/mplevels/mb2_cq_backstreets/map
{
	nopicmip
    {
		map gfx/mplevels/mb2_cq_backstreets/map
		blendfunc blend
		rgbGen vertex
    }
    {
		map gfx/mplevels/mb2_cq_backstreets/map_overlay
		blendfunc blend
		rgbGen identity
    }
}
...
//##### CQD BACKSTREETS
//####################
gfx/automap/mb2_cqd_backstreets
{
	nopicmip
    {
		clampmap gfx/automap/mb2_cqd_backstreets
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_cqd_backstreetsfull
{
	nopicmip
    {
		map gfx/automap/mb2_cqd_backstreetsfull
		blendfunc blend
		alphaGen vertex
    }
}

gfx/mplevels/mb2_cqd_backstreets/map
{
	nopicmip
    {
		map gfx/mplevels/mb2_cq_backstreets/map
    ...
    {
		map gfx/mplevels/mb2_cqd_backstreets/map_overlay
		blendfunc blend
		rgbGen identity
    }
}
...
//##### CQ ENCLAVE
//####################
gfx/automap/mb2_cq_enclave
{
	nopicmip
    {
		clampmap gfx/automap/mb2_cq_enclave
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_cq_enclavefull
{
	nopicmip
    {
		map gfx/automap/mb2_cq_enclavefull
		blendfunc blend
		alphaGen vertex
    }
}

gfx/mplevels/mb2_cq_enclave/map
{
	nopicmip
    {
		map gfx/mplevels/mb2_cq_enclave/map
		blendfunc blend
		rgbGen vertex
    }
    {
		map gfx/mplevels/mb2_cq_enclave/map_overlay
		blendfunc blend
		rgbGen identity
    }
}
...
//##### CQ SCARIF
//####################
gfx/automap/mb2_cq_scarif
{
	nopicmip
    {
		clampmap gfx/automap/mb2_cq_scarif
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_cq_scariffull
{
	nopicmip
    {
		map gfx/automap/mb2_cq_scariffull
		blendfunc blend
		alphaGen vertex
    }
}

gfx/mplevels/mb2_cq_scarif/map
{
	nopicmip
    {
		map gfx/mplevels/mb2_cq_scarif/map
		blendfunc blend
		rgbGen vertex
    }
    {
		map gfx/mplevels/mb2_cq_scarif/map_overlay
		blendfunc blend
		rgbGen identity
    }
}
...
gfx/automap/mb2_deathstar0
{
	nopicmip
    {
		clampmap gfx/automap/mb2_deathstar0
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_deathstar1
{
	nopicmip
    {
		clampmap gfx/automap/mb2_deathstar1
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_deathstar2
{
	nopicmip
    {
		clampmap gfx/automap/mb2_deathstar2
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_deathstar3
{
	nopicmip
    {
		clampmap gfx/automap/mb2_deathstar3
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/mp/mplevels/mb2_deathstar/DeathStarLayout
{
	nopicmip
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout
		blendfunc blend
		rgbGen vertex
    }
	{
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout_Overlay
		blendfunc blend
		rgbGen identity
    }
}

gfx/mp/mplevels/mb2_deathstar/DeathStarLayout0
{
	nopicmip
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout0
		blendfunc blend
		rgbGen vertex
    }
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout0_Overlay
		blendfunc blend
		rgbGen identity
    }
}

gfx/mp/mplevels/mb2_deathstar/DeathStarLayout1
{
	nopicmip
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout1
		blendfunc blend
		rgbGen vertex
    }
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout1_Overlay
		blendfunc blend
		rgbGen identity
    }
}

gfx/mp/mplevels/mb2_deathstar/DeathStarLayout2
{
	nopicmip
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout2
		blendfunc blend
		rgbGen vertex
    }
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout2_Overlay
		blendfunc blend
		rgbGen identity
    }
}

gfx/mp/mplevels/mb2_deathstar/DeathStarLayout3
{
	nopicmip
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout3
		blendfunc blend
		rgbGen vertex
    }
    {
		map gfx/mp/mplevels/mb2_deathstar/DeathStarLayout3_Overlay
		blendfunc blend
		rgbGen identity
    }
}
...
//##### DUEL DANTOOINE
//####################
gfx/automap/mb2_duel_dantooine
{
	nopicmip
    {
		clampmap gfx/automap/mb2_duel_dantooine
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_duel_dantooinefull
{
	nopicmip
    {
		map gfx/automap/mb2_duel_dantooinefull
		blendfunc blend
		alphaGen vertex
    }
}

gfx/mplevels/mb2_duel_dantooine/map
{
	nopicmip
    {
		map gfx/mplevels/mb2_duel_dantooine/map
        blendfunc blend
        rgbGen vertex
    }
}
...
//##### ENCLAVE
//####################
gfx/automap/mb2_enclave
{
	nopicmip
    {
		clampmap gfx/automap/mb2_enclave
		blendfunc blend
		alphaGen vertex
		depthfunc equal
    }
...
gfx/automap/mb2_enclavefull
{
	nopicmip
    {
		map gfx/automap/mb2_enclavefull
		blendfunc blend
		alphaGen vertex
    }
}

gfx/mplevels/mb2_enclave/map
{
	nopicmip
    {
		map gfx/mplevels/mb2_enclave/map
		blendfunc blend
		rgbGen vertex
    }
    {
		map gfx/mplevels/mb2_enclave/map_overlay
		blendfunc blend
		rgbGen identity
    }
}
